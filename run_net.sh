python GMF_keras.py --batch_size 256 --reg 0.0 --lr 0.01 --n_emb 8  --epochs 30
python GMF_keras.py --batch_size 256 --reg 0.0 --lr 0.01 --n_emb 16 --epochs 30
python GMF_keras.py --batch_size 256 --reg 0.0 --lr 0.01 --n_emb 32 --epochs 30
python GMF_keras.py --batch_size 256 --reg 0.0 --lr 0.01 --n_emb 64 --epochs 30
python GMF_keras.py --batch_size 256 --reg 0.0 --lr 0.001 --n_emb 32 --epochs 30
python GMF_keras.py --batch_size 256 --reg 0.0 --lr 0.001 --n_emb 64 --epochs 30

python GMF_pytorch.py --batch_size 256 --lr 0.01 --n_emb 8  --epochs 30
python GMF_pytorch.py --batch_size 256 --lr 0.01 --n_emb 16 --epochs 30
python GMF_pytorch.py --batch_size 256 --lr 0.01 --n_emb 32 --epochs 30
python GMF_pytorch.py --batch_size 256 --lr 0.01 --n_emb 64 --epochs 30
...
python GMF_gluon.py --batch_size 256 --lr 0.01 --n_emb 16 --epochs 30
python GMF_gluon.py --batch_size 256 --lr 0.01 --n_emb 32 --epochs 30
python GMF_gluon.py --batch_size 256 --lr 0.01 --n_emb 64 --epochs 30
python GMF_gluon.py --batch_size 256 --lr 0.001 --n_emb 32 --epochs 30
python GMF_gluon.py --batch_size 256 --lr 0.001 --n_emb 64 --epochs 30
